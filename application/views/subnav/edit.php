...
<form action="<?= base_url('subnav/update/').$subnav['sub_nav_id'] ?>" method="post">
...
<div class="me-form">
	<label for="sub_nav_name">Nama Subnav</label>
  	<input class="shadow rd" type="text" id="sub_nav_name" required name="sub_nav_name" value="<?= $subnav['sub_nav_name'] ?>">
</div>

<div class="me-form">
	<label for="sub_nav_link">Link Subnav</label>
  	<input class="shadow rd" type="text" id="sub_nav_link" required name="sub_nav_link" value="<?= $subnav['sub_nav_link'] ?>">
</div>

<div class="me-form">
	<label for="sub_nav_icon">Icon Subnav</label>
  	<input class="shadow rd" type="text" id="sub_nav_icon" required name="sub_nav_icon" placeholder="Fontawesome" value="<?= $subnav['sub_nav_icon'] ?>">
</div>
...
<div class="me-form">
	...
	<select required name="nav_id" class="shadow rd">
		...
		<option <?php if ($n['nav_id']==$subnav['nav_id']){echo "selected";} ?> value="<?= $n['nav_id'] ?>"><?= $n['nav_name'] ?></option>
		<?php endforeach ?>
	</select>
</div>
